// NOTE: This endpoint is currently not wired to a working Wave mutation for invoice payments
// and is considered experimental / deprecated. The recommended way to record cash/bank
// movements is now /api/wave/transactions/create using moneyTransactionCreate.
